...
static std::string howTo = "(Press \"P\" To Practice)";
...
void Ev_Spawn_Jerry()
{
	...
	{
		// initialisationa
		ConsoleRender::Add_String(howTo, { Find_Ctr_X((int)howTo.size()) - 2 , linkGrid->link[0][linkGrid->Get_Rows() - 1].Get_XY().y - 2 }, GRAY, TXT_SPD_FAST); // affiche ce titre
