...
void Lvl_1_Spwn_Script()
{
	if (gSpawnThisCycle)
	{
		...
		if(numSpawnWaves > 18)	// Les 20 premier spawns seront manuel
			Add(1);
		...
		case 3: Add(1); break;//gBoxSide = RIGHT;gSpwNum = 1; break;
		case 4: Add(1); break;//gBoxSide = RIGHT;gSpwNum = 2; break;
		case 5: Add(1); break;//gBoxSide = RIGHT;gSpwNum = 3; break;
		case 6: Add(1); break;//gBoxSide = RIGHT;gSpwNum = 4; break;
		case 7: Add(1); break;//gBoxSide = RIGHT;gSpwNum = 2; break;
		case 8: Add(1); break;//gBoxSide = RIGHT;gSpwNum = 3; break;
		case 9: Add(1); break;//gBoxSide = RIGHT;gSpwNum = 4; break;
		case 10:Add(1); break;//gBoxSide = RIGHT;gSpwNum = 4; break;
		// Stretch un peu le puzzle ici
		case 11:Add(1);gBoxSide = RIGHT; gSpwNum = 0;break;
		case 12:Add(1);gBoxSide = RIGHT; gSpwNum = 1; break;
		case 13:Add(1);gBoxSide = RIGHT; gSpwNum = 2; break;
		case 14:Add(1);gBoxSide = RIGHT; gSpwNum = 3; break;
		case 15:Add(1);gBoxSide = RIGHT; gSpwNum = 4; break;
		case 16:Add(1);gBoxSide = RIGHT; gSpwNum = 0; Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() / 2); Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() / 2 + 1); break;		// Add(1); gBoxSide = LEFT; gSpwNum = spawnGrid->Get_MaxSpwnCrdY() - 1; // CETTE FORMULE CRASH 100% DU TEMPS
		case 17:Add(1);gBoxSide = RIGHT; Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() / 2 + 2); break;
		case 18:Add(1);gBoxSide = RIGHT; Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() / 2 + 3);break;
			////puzzle end------------------------------------------------------------------
		...
		case 30: gNumSpawnTOT = 0;skip = 1;	break;
		...
		case 34:Add(1); Set_Interval(RIGHT, 5, 6); skip = 3; break;
		...
		case 39:Add_Spec(LEFT, 0); Add_Spec(RIGHT, spawnGrid->Get_MaxSpwnCrdY() - 1); skip = 3; break;
			////puzzle end------------------------------------------------------------------
		...
		case 44: Set_Interval(LEFT, 2, 7); Add(1); skip = 3; break;
		...
		case 49: gNumSpawnTOT = 0; 	MsgQueue::Register(CHECKPOINT_REACHED); 
			break;
...
/*
	case 1: Set_Dr_Map_1(TXT_SPD_DR * 2 + 3);skip = 2; break; // Erase la border seulement si le joueur est en mode quickstartS
		...
		case 5:Add_Spec(RIGHT, 0);skip = 1;break;
		case 6:Add(1);gBoxSide = RIGHT; break;
		case 7:Add(1);gBoxSide = RIGHT; break;
		case 8:Add(1);gBoxSide = RIGHT; break;
		case 9:Add(1);gBoxSide = RIGHT; break;
		case 10:Add(1); Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() - 1);break;	// Spawn Left Now
		case 11:gBoxSide = LEFT; break;
		case 12:gBoxSide = LEFT; gSpwNum = 0; break;
		case 13:gBoxSide = LEFT; gSpwNum = 1; break;
		case 14:gBoxSide = LEFT; gSpwNum = 2; break;
		case 15:gBoxSide = LEFT; gSpwNum = 3; break;
		case 16:gBoxSide = LEFT; gSpwNum = 0; Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() / 2); Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() - 1); break;		// Add(1); gBoxSide = LEFT; gSpwNum = spawnGrid->Get_MaxSpwnCrdY() - 1; // CETTE FORMULE CRASH 100% DU TEMPS
		case 17:gBoxSide = LEFT; Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() / 2); break;
		case 18:gBoxSide = LEFT; Add_Spec(LEFT, spawnGrid->Get_MaxSpwnCrdY() / 2);break;
