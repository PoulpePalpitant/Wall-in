...
static Event ev_Dr_NewGoal(Ev_Dr_New_Goal2 , 3);
static Event ev_Er_NewGoal(Ev_Er_New_Goal2);
static std::string _1 = "- NEW GOAL -"; ;
static std::string _2 = "Do Something With Your Life";
//static std::string _2 = "Find Something To Do";


void Ev_Dr_New_Goal2()			// Accueil Le joueur quand il sort de son répit
{
