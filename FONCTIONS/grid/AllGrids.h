...
public:
	...
	WallGrid* Find_Wall_Grid_From_Crd_Incrementor(GridIndexIncrementor crd);	// Trouve le grid de wall qui correspond à un axe	
	...
	GridIndexIncrementor Convert_LinkCrd_To_WallCrd(GridIndexIncrementor linkCrd);	// Trouve un wall qui possède la même position qu'un Link avec la polarisation et l'axe
